...
class CourseControllerTest {
    ...
    @Autowired
    WebApplicationContext webApplicationContext;  //* simulates a web application
    ...
    void saveCourse_validCourse_courseSaved() throws Exception {
        ...
        Teacher teacher = new Teacher("nuevo teacher2", address);
        Course course = new Course("Testing2", 100, "A1", "2 weeks", teacher);
        ...
        mockMvc.perform(delete("/api/courses/testing2"))
    ...
    void deleteCourse__courseDeleted() throws Exception {
        ...
        assertFalse(mvcResult.getResponse().getContentAsString().contains("Testing2"));
    }
}
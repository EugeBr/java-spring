package com.ironhack.w3d2.service.impl;
...
public class CourseService implements ICourseService {
    ...
    public void saveCourse(Course course) {
        Optional<Course> courseOptonal = courseRepository.findById(course.getCourse());
        if(courseOptonal.isPresent()) throw new ResponseStatusException(HttpStatus.UNPROCESSABLE_ENTITY, "The course already exist");
